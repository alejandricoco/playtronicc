...
class FragmentAvisoEnlaceAcc : Fragment() {

    private lateinit var btnAceptarExito: Button
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_aviso_enlace_acc, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        btnAceptarExito = view.findViewById(R.id.buttonAceptarExito)
